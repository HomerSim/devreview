        ...
        <div className="max-w-md mx-auto text-center">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="space-y-3">
              <Link
                href="/feed"
                className="block w-full bg-sky-600 hover:bg-sky-700 text-white px-4 py-2 rounded-lg transition-colors text-center"
              >
                피드로 이동
              </Link>
              <Link
                href="/"
                className="block w-full text-gray-600 hover:text-gray-900 transition-colors text-center"
              >
                홈으로 돌아가기
              </Link>
            </div>
